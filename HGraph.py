...
class HGraph:
    ...
    #TODO parameterize
    def drawFrame(self):
        fname = 'animation/%03d.png' % self.frameCnt
        self.frameCnt += 1
        self.draw(fname)
    ...
    def makeVideo(self):
        system('for f in animation/???.png; do convert $f -resize 200% $f; done')
        system('rm video.mp4')
        system('avconv -r 1 -i animation/%03d.png -b:v 1000k video.mp4 > /dev/null 2>&1')
